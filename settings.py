...
ROOMS = [
    ...
    dict(name='room2', display_name= 'Room #2 SG session', participant_label_file='_rooms/room2.txt'),
    dict(name='room3', display_name= 'Room #3 SG session', participant_label_file='_rooms/room3.txt')
]
